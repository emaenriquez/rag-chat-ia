...
-- AddForeignKey
ALTER TABLE "source_references" ADD CONSTRAINT "source_references_chunk_id_fkey" FOREIGN KEY ("chunk_id") REFERENCES "document_chunks"("id") ON DELETE CASCADE ON UPDATE CASCADE;
